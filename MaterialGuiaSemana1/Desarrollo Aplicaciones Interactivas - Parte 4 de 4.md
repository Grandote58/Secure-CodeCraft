# Desarrollo Aplicaciones Interactivas - Parte 4 de 4

**CustomTkinter** - https://customtkinter.tomschimansky.com/

Agregar dos nuevas funcionalidades:

1. **Búsqueda de estudiantes**: Vamos a implementar un cuadro de búsqueda para filtrar estudiantes por nombre.
2. **Exportar a CSV**: Permitiremos la exportación de los datos de estudiantes a un archivo CSV.

### Paso 1: Implementar la búsqueda de estudiantes

Aquí está el código actualizado con la funcionalidad de búsqueda:
...
1. **Búsqueda de estudiantes**:
   - Se ha añadido un cuadro de texto y un botón de búsqueda. Al ingresar el nombre de un estudiante (o parte de él) y hacer clic en "Buscar Estudiante", la tabla se actualizará con los resultados filtrados.
2. **Exportación a CSV**:
   - Se ha añadido un botón para exportar los estudiantes a un archivo CSV. Al hacer clic en "Exportar a CSV", los datos de los estudiantes se guardan en un archivo llamado `estudiantes.csv` en el directorio actual.